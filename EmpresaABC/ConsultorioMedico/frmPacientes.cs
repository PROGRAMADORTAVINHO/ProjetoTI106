...
namespace ConsultorioMedico
{
    public partial class frmPacientes : Form
    {
        ...
        public void excluirpaciente(int codPac)
        {
            ...
            comm.Parameters.Add("@codPac", MySqlDbType.Int32, 12).Value = Convert.ToInt32(txtCodigo.Text);



            DialogResult vresp = MessageBox.Show("Deseja Realezar a Exclusão", "Mesagem do Sistema", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2);
